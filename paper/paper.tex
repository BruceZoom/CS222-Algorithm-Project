...
\begin{algorithm}[h]
	...
	\begin{algorithmic}[1]
		...
		\Ensure $D$, a classifier set satisfying constraints, or $\varnothing$ if not feasible.
		\State $Q \gets \varnothing$; \Comment A priority queue, the last element $h$ is the key
