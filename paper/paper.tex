...
\begin{abstract}
  ...
  Experiments show that we can reduce about $90\%$ computing consumption by pruning convolution kernels in networks while maintain a high classification accuracy for partial classification.
\end{abstract}
...
\section{Conclusion}
To develop task-specific and light-weighted models for edge devices, we propose a general assembly framework for binary classifers in this paper.
We formulate the choice of these classifiers into a search problem and design a heuristic search algorithm for it.
